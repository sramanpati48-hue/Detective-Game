...
// --- 4x2 CORKBOARD CASES REGISTRY (CASE 001 PLAYABLE; CASES 002-008 DOCKET PENDING) ---
const CASES = [
  {
    id: "001",
    code: "CASE 001",
  ...
  },
  {
    ...
    location: "Boipara, College St",
    stars: 3,
    players: "1-2 Players",
    playTime: "50 - 65 mins",
    image: "/cases/case_002.png",
    briefImage: "/cases/case_brief_ferry.png",
    quote: "Every book has a price. Some cost lives.",
    description:
      "An antique bookbinder is found unconscious behind a locked stack in College Street. The missing volume details colonial municipal land deeds.",
  ...
  },
  {
    ...
    briefImage: "/cases/case_brief_ferry.png",
    quote: "The rails never forget where they lead.",
    description:
      "Midnight tram #18 stopped dead on the Bidhan Sarani curve. Inside the motorman's cabin, an encrypted radio spool still hums.",
  ...
  },
  {
    ...
    briefImage: "/cases/case_brief_ferry.png",
    quote: "Dynasties bury their secrets deep in marble.",
    description:
      "During the Durga Puja immersion, an ancient heirloom disappears from the inner courtyard of Sovabazar Rajbari. Bloodstains lead to the river gate.",
  ...
  },
  {
    ...
    briefImage: "/cases/case_brief_ferry.png",
    quote: "Morning steam hides cold tracks.",
    description:
      "At dawn in the Chinese quarter, a leather shoemaker's ledger is discovered burned in an alley barrel. A witness vanishes into the morning mist.",
  ...
  },
  {
    ...
    briefImage: "/cases/case_brief_ferry.png",
    quote: "Clay hides what flesh cannot confess.",
    description:
      "Inside an unbaked clay idol on Banamali Sarkar Street, CID officers uncover an unregistered Swiss revolver and a ticket to Dhaka.",
  ...
  },
  {
    ...
    briefImage: "/cases/case_brief_ferry.png",
    quote: "Neon lights cast the darkest shadows.",
    description:
      "A private vault in Queen's Mansion is emptied during a jazz recital. No locks were forced; only an aromatic cigar band was left behind.",
  ...
  },
  {
    ...
    briefImage: "/cases/case_brief_ferry.png",
    quote: "The fog swallows the river. And the dead.",
    description:
      "Under the cantilever steel of Howrah Bridge, a night watchman spots a floating cargo chest. Inside lies an unsolved case file from 1952.",
